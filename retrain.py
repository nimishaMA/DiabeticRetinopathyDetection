...
def get_image_path(image_lists, label_name, index, image_dir, category):
    ...
    try:
        ...
        return '/tmp/bottleneck\\csme\\labeled_1.png'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default=r'C:\Users\User\Documents\Retinopathy\train_data',
        help='Path to folders of labeled images.'
    )
    parser.add_argument(
        '--output_graph',
        type=str,
        default=r'C:\Users\User\Documents\Retinopathy\train_model\output_graph.pb',
    ...
    parser.add_argument(
        '--output_labels',
        type=str,
        default=r'C:\Users\User\Documents\Retinopathy\train_model\output_labels.txt',
